(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://raw.githubusercontent.com/ImWiked7/langcro/master/cro.json", function (json) {
            ...
            commandsCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat(basicBot.chat.commandslink, {botname: MTV Da Bot.settings.botName, link: basicBot.cmdLink}));
                    }
                }
            },
